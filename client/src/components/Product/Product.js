...
const Product = (props) => {
    ...
    return ( 
        <div className="col cursor-pointer" onClick = {()=>{showProduct(product._id)}}>
            <div className="card h-100">
                ...
                <div className="card-body">
                    ...
                    <p className="card-text text-secondary">{product.description ? product.description.slice(0,35) + ' .....'  : 'description unavailable'}</p>
                </div>
